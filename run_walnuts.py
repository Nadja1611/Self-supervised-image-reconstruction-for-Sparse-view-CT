...
images = get_images("C:/Users/nadja/Documents/Sparser2Sparse_tomosipo/Sparser2Sparse_tomosipo/Sparse2Sparse_new/walnuts")
...
newpath = r'C:/Users/nadja/Documents/Sparser2Sparse - Copy/Results_walnuts/'+loss_variant +"_" + str(learning_rate) +"_angles_" + str(number_angles) +"_noise_" + str(photon_count)
